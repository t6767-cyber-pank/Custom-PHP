...
<div align="center" style="float: left; width: 100%; ">
    <h1>Склад розница</h1>
    <br>
<table class="table table-hover" style="width: 90%; background: aliceblue; border-radius: 1%;">
    <thead>
    <tr>
        <th scope="col">#</th>
        <th scope="col">Название</th>
        <th scope="col">Количествово</th>
    ...
    <tbody>
<?php
$qrqcity = mysql_query("SELECT * FROM `pr_tovar` t, skladrozn s where t.pokaz>0 and t.id=s.idtovar $selname ORDER BY t.name ASC");
$i=0;
