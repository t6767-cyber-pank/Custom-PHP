...
else
{
    ...
    header('Location: /sklad/prihod.php');
}
...
<div align="center" style="float: right; width: 100%;">
    ...
    <form class="needs-validation" method="POST">
        ...
        <td>
                ...
                <input type='hidden' name='napr' value='1'>
        </td>
        <td style="padding: 10px;">
    ...
    <table class="table table-hover" style="width: 90%; background: floralwhite; border-radius: 1%;">
        ...
        <tbody>
        <?php
        $qrqcity = mysql_query("SELECT * FROM `pr_tovar` t, skladprih s where t.pokaz>0 and napr=1 and t.id=s.idtovarprih $selname $seldate ORDER BY s.data DESC, t.name ASC");
        $i=0;
