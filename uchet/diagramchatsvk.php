...
if ($rash>0) $str='rashvk'; else $str='obshvk';

if ($_POST['operation']=='show_masters') {
    $diagrams->showAllCityVK($rash);
    $diagrams->showAllCitySummaryVK($rash);
...
function getallDiag($diagrams, $str)
{
    ...
    <div class="container-fluid T_M_DIAG_Prostor">
        <div class="row">
            ...
            <div class="col-8">
                ...
                <br><span class="T_M_diag_podzagmargin">за период: </span><span class="T_M_Diag_Charts_sum"><?php echo $diagrams->getChatsAllOfAllVK(); ?></span>
                <?php if ($diagrams->access>0) { ?>
                    <span>, расходы: </span><span class="T_M_Diag_outcomes_sum"><?php echo $diagrams->getallOutcomesIntervalVK(); ?></span>
                    <span>, цена за лид: </span><span class="T_M_DIAG_LID"><?php if ($diagrams->getallOutcomesIntervalVK()!=0 && $diagrams->getChatsAllOfAllVK()!=0) echo round($diagrams->getallOutcomesIntervalVK()/$diagrams->getChatsAllOfAllVK()); ?></span>
                <?php } ?>
    ...
    <div class="container-fluid T_M_DIAG_Prostor">
        <div class="row">
            ...
            <div class="col-8">
                <?php
                $city=$diagrams->getAllCitiesVK();
                foreach ($city as $cid)
                {
                    $mas=$masters->MastersByCityVK($cid[0]);
                    $first=true;
                    ?>
                    <div class="T_M_DIAG_Prostor">
                        ...
                        <br><span class="T_M_diag_podzagmargin">за период: </span><span class="T_M_Diag_Charts_sum"><?php echo $diagrams->getallChatsSumVK($cid[0]); ?></span>
                        <?php if ($diagrams->access>0) { ?>
                            <span>, расходы: </span><span class="T_M_Diag_outcomes_sum"><?php echo $diagrams->getallOutcomesVKSum($cid[0]); ?></span>
                            <span>, цена за лид: </span><span class="T_M_DIAG_LID"><?php if ($diagrams->getallOutcomesVKSum($cid[0])!=0 && $diagrams->getallChatsSumVK($cid[0])!=0) echo round($diagrams->getallOutcomesVKSum($cid[0])/$diagrams->getallChatsSumVK($cid[0])); ?></span>
                        <?php } ?>
