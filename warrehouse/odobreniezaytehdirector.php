...
echo '<div align="center"><form method="POST" action="odobreniezakup.php">';
echo '<table border="1">';
  echo '<thead>';
  echo '<tr>';
  ...
  while($data = @mysql_fetch_array($qr_result)){ 
	...
	echo '<input type="hidden" name="cenazaed'.$counter.'" value="' .$data['cenazaed'].'">';
  ...
  echo '<br><br><input name="obrik" type="submit" value="Выполнить"> <br><br>';
  echo '</form></div>';
?>
<div align="center">
