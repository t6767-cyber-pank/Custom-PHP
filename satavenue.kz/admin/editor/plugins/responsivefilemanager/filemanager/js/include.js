...
!function (e, a, t) {
	...
	function i() {
		...
		bootbox.dialog(a, [{label: e("#cancel").val(), "class": "btn"}, {
			label: e("#ok").val(),
			"class": "btn-inverse",
			callback: function () {
				...
				if (null !== a) {
					a = w(a);
					var n = e("#sub_folder").val() + e("#fldr_value").val() + a, i = e("#cur_dir_thumb").val() + a;
					e.ajax({
						type: "POST",
						url: "execute.php?action=create_file",
						data: {path: n, path_thumb: i, name: a, new_content: t}
					}).done(function (a) {
	...
	function r(a) {
		...
		var t = a.find(".rename-file").attr("data-thumb"), n = a.find(".rename-file").attr("data-path");
		e.ajax({
			type: "POST",
			url: "ajax_calls.php?action=get_file&sub_action=edit&preview_mode=text",
			data: {path: n}
		}).done(function (i) {
			bootbox.dialog(i, [{label: e("#cancel").val(), "class": "btn"}, {
				label: e("#ok").val(),
				"class": "btn-inverse",
				callback: function () {
					...
					e.ajax({
						...
						data: {path: n, path_thumb: t, new_content: a}
					}).done(function (e) {
						"" != e && bootbox.alert(e)
					})
				}
	...
	function l(a) {
		...
		var t, n;
		a.hasClass("directory") ? (t = a.find(".rename-folder").attr("data-thumb"), n = a.find(".rename-folder").attr("data-path")) : (t = a.find(".rename-file").attr("data-thumb"), n = a.find(".rename-file").attr("data-path")), e.ajax({
			type: "POST",
			url: "ajax_calls.php?action=chmod",
			data: {path: n, path_thumb: t}
		}).done(function (a) {
			bootbox.dialog(a, [{label: e("#cancel").val(), "class": "btn"}, {
				label: e("#ok").val(),
				"class": "btn-inverse",
				callback: function () {
					...
					if ("" != a && "undefined" != typeof a) {
						var i = e("#chmod_form input[name=apply_recursive]:checked").val();
						("" == i || "undefined" == typeof i) && (i = "none"), e.ajax({
							type: "POST",
							url: "execute.php?action=chmod",
							data: {path: n, path_thumb: t, new_mode: a, is_recursive: i}
						}).done(function (e) {
							"" != e && bootbox.alert(e)
						})
					}
	...
	function c(a) {
		...
		if (t.user = 0, t.group = 0, t.all = 0, "undefined" != typeof a && 1 == a) {
			...
			t.user = n.substr(0, 1), t.group = n.substr(1, 1), t.all = n.substr(2, 1), e.each(t, function (a) {
				...
				d(t[a], n) ? e(this).prop("checked", !0) : e(this).prop("checked", !1)
			})
	...
	function s() {
		bootbox.confirm(e("#lang_clear_clipboard_confirm").val(), e("#cancel").val(), e("#ok").val(), function (a) {
			1 == a && e.ajax({type: "POST", url: "ajax_calls.php?action=clear_clipboard", data: {}}).done(function (a) {
				"" != a ? bootbox.alert(a) : e("#clipboard").val("0"), m(!1)
			})
		})
	}
	...
	function p(a, t) {
		if ("copy" == t || "cut" == t) {
			var n, i;
			a.hasClass("directory") ? (n = a.find(".rename-folder").attr("data-thumb"), i = a.find(".rename-folder").attr("data-path")) : (n = a.find(".rename-file").attr("data-thumb"), i = a.find(".rename-file").attr("data-path")), e.ajax({
				type: "POST",
				url: "ajax_calls.php?action=copy_cut",
				data: {path: i, path_thumb: n, sub_action: t}
			}).done(function (a) {
				"" != a ? bootbox.alert(a) : (e("#clipboard").val("1"), m(!0))
			})
		}
	}
	...
	function f(a) {
		bootbox.confirm(e("#lang_paste_confirm").val(), e("#cancel").val(), e("#ok").val(), function (t) {
			if (1 == t) {
				var n, i;
				"undefined" != typeof a ? (n = a.find(".rename-folder").attr("data-path"), i = a.find(".rename-folder").attr("data-thumb")) : (n = e("#sub_folder").val() + e("#fldr_value").val(), i = e("#cur_dir_thumb").val()), e.ajax({
					type: "POST",
					url: "execute.php?action=paste_clipboard",
					data: {path: n, path_thumb: i}
				}).done(function (a) {
					"" != a ? bootbox.alert(a) : (e("#clipboard").val("0"), m(!1), setTimeout(function () {
						window.location.href = e("#refresh").attr("href") + "&" + (new Date).getTime()
					}, 300))
				})
			}
	...
	function u(a, t) {
		...
		var i = n.attr("data-thumb"), r = n.attr("data-path");
		a.parent().hide(100), e.ajax({
			type: "POST",
			url: "ajax_calls.php?action=copy_cut",
			data: {path: r, path_thumb: i, sub_action: "cut"}
		}).done(function (n) {
			if ("" != n)bootbox.alert(n); else {
				var i, r;
				"undefined" != typeof t ? t.hasClass("back-directory") ? (i = t.find(".path").val(), r = t.find(".path_thumb").val()) : (i = t.find(".rename-folder").attr("data-path"), r = t.find(".rename-folder").attr("data-thumb")) : (i = e("#sub_folder").val() + e("#fldr_value").val(), r = e("#cur_dir_thumb").val()), e.ajax({
					type: "POST",
					url: "execute.php?action=paste_clipboard",
					data: {path: i, path_thumb: r}
				}).done(function (t) {
					"" != t ? (bootbox.alert(t), a.parent().show(100)) : (e("#clipboard").val("0"), m(!1), a.parent().remove())
				})
			}
		}).error(function () {
			a.parent().show(100)
	...
	function h() {
		var a = e(this);
		0 == e("#view").val() && (1 == a.attr("toggle") ? (a.attr("toggle", 0), a.animate({top: "0px"}, {
			queue: !1,
			duration: 300
		})) : (a.attr("toggle", 1), a.animate({top: "-30px"}, {queue: !1, duration: 300})))
	}
	...
	function _() {
		1 == e("#popup").val() ? window.close() : "undefined" != typeof parent.jQuery && parent.jQuery ? parent.jQuery.fancybox.close() : parent.$.fancybox.close()
	}
	...
	function w(a) {
		return null != a ? ("true" == e("#transliteration").val() && (a = g(a), a = a.replace(/[^A-Za-z0-9\.\-\[\] _]+/g, "")), "true" == e("#convert_spaces").val() && (a = a.replace(/ /g, e("#replace_with").val()), a = a.toLowerCase()), a = a.replace('"', ""), a = a.replace("'", ""), a = a.replace("/", ""), a = a.replace("\\", ""), a = a.replace(/<\/?[^>]+(>|$)/g, ""), e.trim(a)) : null
	}

	function y(a, t, n, i, r, o) {
		null !== i && (i = w(i), e.ajax({
			type: "POST",
			url: "execute.php?action=" + a,
			data: {path: t, path_thumb: n, name: i.replace("/", "")}
		}).done(function (e) {
			return "" != e ? (bootbox.alert(e), !1) : ("" != o && window[o](r, i), !0)
		}))
	}
	...
	var j = "9.9.2", T = !0, I = 0, O = function () {
		var e = 0;
		return function (a, t) {
		...
		contextActions: {
			copy_url: function (a) {
				...
				i.attr("data-name", t), i.attr("src", n).load(k(i.attr("id"), n))
				...
				bootbox.prompt(e("#lang_duplicate").val(), e("#cancel").val(), e("#ok").val(), function (e) {
					if (null !== e && (e = w(e), e != t)) {
						...
						y("duplicate_file", n.attr("data-path"), n.attr("data-thumb"), e, n, "apply_file_duplicate")
					}
				}, t)
			}, select: function (a) {
				var t = S(a), n = e("#field_id").val();
				if ("" != n)if (1 == e("#crossdomain").val())windowParent.postMessage({
					sender: "responsivefilemanager",
					url: t,
					field_id: n
				}, "*"); else {
					var i = e("#" + n, windowParent.document);
					i.val(t).trigger("change"), "function" == typeof windowParent.responsive_filemanager_callback && windowParent.responsive_filemanager_callback(n), _()
				} else apply_any(t)
			}, copy: function (e) {
				p(e, "copy")
			}, cut: function (e) {
			...
			e.contextMenu({
				...
				build: function (n) {
					...
					return (n.find(".img-precontainer-mini .filetype").hasClass("png") || n.find(".img-precontainer-mini .filetype").hasClass("jpg") || n.find(".img-precontainer-mini .filetype").hasClass("jpeg")) && t && (i.items.edit_img = {
						name: e("#lang_edit_image").val(),
						icon: "edit_img",
						disabled: !1
					}), n.hasClass("directory") && 4 != e("#type_param").val() && (i.items.select = {
						name: e("#lang_select").val(),
						icon: "",
						disabled: !1
					}), i.items.copy_url = {
						name: e("#lang_show_url").val(),
						icon: "url",
						disabled: !1
					}, (n.find(".img-precontainer-mini .filetype").hasClass("zip") || n.find(".img-precontainer-mini .filetype").hasClass("tar") || n.find(".img-precontainer-mini .filetype").hasClass("gz")) && (i.items.unzip = {
						name: e("#lang_extract").val(),
						icon: "extract",
						disabled: !1
					}), n.find(".img-precontainer-mini .filetype").hasClass("edit-text-file-allowed") && (i.items.edit_text_file = {
						name: e("#lang_edit_file").val(),
						icon: "edit",
						disabled: !1
					}), n.hasClass("directory") || 1 != e("#duplicate").val() || (i.items.duplicate = {
						name: e("#lang_duplicate").val(),
						icon: "duplicate",
						disabled: !1
					}), n.hasClass("directory") || 1 != e("#copy_cut_files_allowed").val() ? n.hasClass("directory") && 1 == e("#copy_cut_dirs_allowed").val() && (i.items.copy = {
						name: e("#lang_copy").val(),
						icon: "copy",
						disabled: !1
					}, i.items.cut = {
						name: e("#lang_cut").val(),
						...
						icon: "cut",
						disabled: !1
					}), 0 == e("#clipboard").val() || n.hasClass("directory") || (i.items.paste = {
						name: e("#lang_paste_here").val(),
						icon: "clipboard-apply",
						disabled: !1
					}), n.hasClass("directory") || 1 != e("#chmod_files_allowed").val() ? n.hasClass("directory") && 1 == e("#chmod_dirs_allowed").val() && (i.items.chmod = {
						name: e("#lang_file_permission").val(),
						icon: "key",
						disabled: !1
					}) : i.items.chmod = {
						name: e("#lang_file_permission").val(),
						icon: "key",
						disabled: !1
					}, i.items.sep = "----", i.items.info = {
						name: "<strong>" + e("#lang_file_info").val() + "</strong>",
						disabled: !0
					}, i.items.name = {
						...
						name: n.find(".img-dimension").html(),
						icon: "dimension",
						disabled: !0
					}), i.items.size = {
						name: n.find(".file-size").html(),
						icon: "size",
						disabled: !0
					}, i.items.date = {name: n.find(".file-date").html(), icon: "date", disabled: !0}, i
				},
				events: {
					hide: function () {
			...
			t.on("click", ".modalAV", function (a) {
				...
				n.removeData("modal"), n.modal({
					backdrop: "static",
					keyboard: !1
				}), t.hasClass("audio") ? i.css("height", "80px") : i.css("height", "345px"), e.ajax({
					url: t.attr("data-url"),
					success: function (e) {
						i.html(e)
					}
				...
				a.preventDefault(), e.ajax({
					url: t.attr("data-url"), success: function (e) {
						bootbox.alert(e)
					}
				})
				...
				bootbox.prompt(e("#rename").val(), e("#cancel").val(), e("#ok").val(), function (e) {
					null !== e && (e = w(e), e != i && y("rename_file", a.attr("data-path"), a.attr("data-thumb"), e, t, "apply_file_rename"))
				}, i)
			}), t.on("click", ".rename-folder", function () {
				var a = e(this), t = a.parent().parent().parent(), n = t.find("h4"), i = e.trim(n.text());
				bootbox.prompt(e("#rename").val(), e("#cancel").val(), e("#ok").val(), function (e) {
					null !== e && (e = w(e).replace(".", ""), e != i && y("rename_folder", a.attr("data-path"), a.attr("data-thumb"), e, t, "apply_folder_rename"))
				}, i)
			}), t.on("click", ".delete-file", function () {
				var a = e(this);
				bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function (e) {
					1 == e && (y("delete_file", a.attr("data-path"), a.attr("data-thumb"), "", "", ""), a.parent().parent().parent().parent().remove())
				})
			}), t.on("click", ".delete-folder", function () {
				var a = e(this);
				bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function (e) {
					1 == e && (y("delete_folder", a.attr("data-path"), a.attr("data-thumb"), "", "", ""), a.parent().parent().parent().remove())
				})
			}), e("ul.grid").on("click", ".link", function () {
				a(e(this))
			}), e("ul.grid").on("click", "div.box", function () {
				var t = e(this).find(".link");
				if (0 !== t.length)a(t); else {
					var n = e(this).find(".folder-link");
					0 !== n.length && (document.location = e(n).prop("href"))
				}
			})
			...
			e("#filter-input").on("keyup", function () {
				...
				var t = w(e(this).val()).toLowerCase();
			...
			e("#uploader-btn").on("click", function () {
				...
				a = a.substring(0, a.length - 1), e("#iframe-container").html(e("<iframe />", {
					name: "JUpload",
					id: "uploader_frame",
					src: "uploader/index.php?path=" + a,
					frameborder: 0,
					width: "100%",
					height: 360
				}))
	...
	e(document).ready(function () {
		...
		if (U.makeSort(t), U.makeFilters(t), e("#info").on("click", function () {
				...
				bootbox.prompt(e("#insert_folder_name").val(), e("#cancel").val(), e("#ok").val(), function (a) {
					if (null !== a) {
						a = w(a).replace(".", "");
						var t = e("#sub_folder").val() + e("#fldr_value").val() + a, n = e("#cur_dir_thumb").val() + a;
						e.ajax({
							type: "POST",
							url: "execute.php?action=create_folder",
							data: {path: t, path_thumb: n}
						}).done(function () {
							setTimeout(function () {
								window.location.href = e("#refresh").attr("href") + "&" + (new Date).getTime()
							}, 300)
				...
				e("#view").val(t), e("ul.grid").addClass("list-view" + t), e(".sorter-container").addClass("list-view" + t), a.attr("data-value") >= 1 ? v(14) : (e("ul.grid li").css("width", 126), e("ul.grid figure").css("width", 122)), C()
			}), a.touch ? (e("#help").show(), e(".box:not(.no-effect)").swipe({
				swipeLeft: h,
				swipeRight: h,
				threshold: 30
			})) : (e(".tip").tooltip({placement: "bottom"}), e(".tip-top").tooltip({placement: "top"}), e(".tip-left").tooltip({placement: "left"}), e(".tip-right").tooltip({placement: "right"}), e("body").addClass("no-touch")), e(".paste-here-btn").on("click", function () {
				0 == e(this).hasClass("disabled") && f()
			}), e(".clear-clipboard-btn").on("click", function () {
				0 == e(this).hasClass("disabled") && s()
			}), !a.csstransforms) {
			var r = e("figure");
			r.on("mouseover", function () {
				0 == e("#view").val() && e("#main-item-container").hasClass("no-effect-slide") === !1 && e(this).find(".box:not(.no-effect)").animate({top: "-26px"}, {
					queue: !1,
					duration: 300
				})
			}), r.on("mouseout", function () {
				0 == e("#view").val() && e(this).find(".box:not(.no-effect)").animate({top: "0px"}, {
					queue: !1,
					duration: 300
				})
			})
		...
		e(window).resize(function () {
			v(28)
		}), v(14), m(1 == e("#clipboard").val() ? !0 : !1), e("li.dir, li.file").draggable({
			distance: 20,
			cursor: "move",
			helper: function () {
		...
		c = c.toLowerCase();
		var d = "", s = ["ogg", "mp3", "wav"], p = ["mp4", "ogg", "webm"], f = e("#return_relative_url").val(), u = encodeURL((1 == f ? r : o + i) + a);
		if ("" != t)if (1 == e("#crossdomain").val())n.postMessage({
			sender: "responsivefilemanager",
			url: u,
			field_id: t
		}, "*"); else {
			var m = e("#" + t, n.document);
			m.val(u).trigger("change"), "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), _()
		} else e.inArray(c, ext_img) > -1 ? d = '<img src="' + u + '" alt="' + l + '" />' : e.inArray(c, p) > -1 ? d = '<video controls source src="' + u + '" type="video/' + c + '">' + l + "</video>" : e.inArray(c, s) > -1 ? ("mp3" == c && (c = "mpeg"), d = '<audio controls src="' + u + '" type="audio/' + c + '">' + l + "</audio>") : d = '<a href="' + u + '" title="' + l + '">' + l + "</a>", 1 == e("#crossdomain").val() ? n.postMessage({
			sender: "responsivefilemanager",
			url: u,
			field_id: null,
			html: d
		}, "*") : parent.tinymce.majorVersion < 4 ? (parent.tinymce.activeEditor.execCommand("mceInsertContent", !1, d), parent.tinymce.activeEditor.windowManager.close(parent.tinymce.activeEditor.windowManager.params.mce_window_id)) : (parent.tinymce.activeEditor.insertContent(d), parent.tinymce.activeEditor.windowManager.close())
		...
		if ("" != t)if (1 == e("#crossdomain").val())n.postMessage({
			...
			var d = e("#" + t, n.document);
			d.val(c).trigger("change"), "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), _()
		} else apply_any(c)
		...
		if (1 == e("#crossdomain").val())window.parent.postMessage({
			sender: "responsivefilemanager",
			url: a,
			field_id: null
		}, "*"); else {
		...
		var c = a.find("a.rename-file"), d = a.find("a.delete-file"), s = c.attr("data-path"), p = c.attr("data-thumb"), f = s.replace(r, t + "." + o), u = p.replace(r, t + "." + o);
		c.attr("data-path", f), c.attr("data-thumb", u), d.attr("data-path", f), d.attr("data-thumb", u)
		...
		var c = a.find("a.delete-folder"), d = a.find("a.rename-folder"), s = d.attr("data-path"), p = d.attr("data-thumb"), f = s.lastIndexOf("/"), u = s.substr(0, f + 1) + t;
		c.attr("data-path", u), d.attr("data-path", u);
		var f = p.lastIndexOf("/"), u = p.substr(0, f + 1) + t;
		c.attr("data-thumb", u), d.attr("data-thumb", u)
	}, show_animation = function () {
		e("#loading_container").css("display", "block"), e("#loading").css("opacity", ".7")
	}, hide_animation = function () {
		e("#loading_container").hide()
	}
