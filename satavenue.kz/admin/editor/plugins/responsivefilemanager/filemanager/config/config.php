<?php
	include $_SERVER['DOCUMENT_ROOT']."/admin/include/kernel.inc";
	include $_SERVER['DOCUMENT_ROOT']."/include/configs.inc";
	...
	$UploadDIR=$GLOBAL->UserInfo->RightsAdmin=="Y"?"/imgs/":"/imgs/{$GLOBAL->UserInfo->Id}/";
	$ThumbsDIR=$GLOBAL->UserInfo->RightsAdmin=="Y"?"/imgsthumbs/":"/imgsthumbs/{$GLOBAL->UserInfo->Id}/";
	$CurrentPATH=$_SERVER['DOCUMENT_ROOT'].$UploadDIR;

	$Kernel->CheckCoverDirectory($CurrentPATH);
/*
|--------------------------------------------------------------------------
| Optional security
|--------------------------------------------------------------------------
...
$config = array(
	...
	*/
	...
	'fixed_path_from_filemanager'             => array(), //fixed path of the image folder from the current position on upload folder
	...
	'fixed_image_creation_width'              => array(1200), //width of image (you can leave empty if you set height)
	'fixed_image_creation_height'             => array( 1200), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	#                          4 / crop= resize and crop;
	 */
	'fixed_image_creation_option'             => array( 'auto' ), //set the type of the crop
	...
	'relative_image_creation_width'           => array( 3000, 4000 ), //width of image (you can leave empty if you set height)
	'relative_image_creation_height'          => array( 2000, '' ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
