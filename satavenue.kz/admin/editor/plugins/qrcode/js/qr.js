	...
	$("#generate").click(function() {
	    ...
	    if(datainput == "") {
	        showwarning('Please enter a url or text or look at the Help data formats !','alert-danger');
    ...
    /**
      ...
      Example - showwarning("Invalid Login","alert-error")
      Types of alerts -- "alert-error","alert-success","alert-info"
      Required - You only need to add a alert_placeholder div in your html page wherever you want to display these alerts "<div id="alert_placeholder"></div>"
    **/

    function showwarning(message,alerttype) {
