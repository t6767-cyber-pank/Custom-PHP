...
<noscript><div><img src="https://mc.yandex.ru/watch/57590461" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
<!-- Facebook Pixel Code -->
<script>
  ...
  fbq('init', '887005431740018');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=887005431740018&ev=PageView&noscript=1"
/></noscript>
    ...
    <section class="audit" style="background-image: url('static/img/content/entry-bg.jpg')">
        <div class="container">
            ...
            <div class="audit__text">
                ...
                <br>И, если всё делать правильно, то при их помощи можно успешно генерировать поток клиентов.
            </div>
        ...
        <div class="container">
            ...
            <div class="why__card">
                <div class="why__desktop">
					<div class="swiper-container jsWhyDesktopSlider">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="why__desktop-item">
									...
									<div class="why__stats">
										...
										<div class="why__stats-item">
											<div class="why__stats-title">69 327</div>
							...
							<div class="swiper-slide">
								<div class="why__desktop-item">
									...
									<div class="why__stats">
										...
										<div class="why__stats-item">
											<div class="why__stats-title">до 10%</div>
											<div class="why__stats-text">рост конверсии</div>
										</div>
									</div>
							...
							<div class="swiper-slide">
								<div class="why__desktop-item">
									...
									<div class="why__stats">
										<h5>Результат</h5>
										<div class="why__stats-item">
											<div class="why__stats-title">12 000</div>
											<div class="why__stats-text">активной аудитории</div>
										</div>
										<div class="why__stats-item">
								...
								<div class="why__desktop-item">
									...
									<div class="why__stats">
										...
										<div class="why__stats-item">
											...
											<div class="why__stats-text">увеличили объем продаж</div>
										</div>
									</div>
            ...
            <div class="container footer__container">
                <form class="footer__form">
                    ...
                    <div class="footer__contacts">
                        г. Алматы, улица 24 Июня
						<br> БЦ "AizEx", офис 407, 409
                        <br>+7 (708) 103-74-85
                        <br>info@9oweb.kz
                    </div>
		...
		<div id="modal-subscribe" class="modal modal-subscribe fade" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-subscribe__hint">Специальное предложение действует только до конца апреля при условии заключения договора, минимум, на 3 месяца.</div>
				</div>
			</div>
		</div>
		<!--/. Modal Subscribe End -->	
...
<!-- Yandex.Metrika counter --> <script type="text/javascript" > (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date();k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://mc.yandex.ru/metrika/tag.js";, "ym"); ym(57590461, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true }); </script> <noscript><div><img src="https://mc.yandex.ru/watch/57590461"; style="position:absolute; left:-9999px;" alt="" /></div></noscript> <!-- /Yandex.Metrika counter -->
</body>
</html>
